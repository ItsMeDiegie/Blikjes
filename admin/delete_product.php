        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <!-- <div class="btn-group" role="group"> -->
              <button class="btn btn-lg btn-primary btn-block text-uppercase" name="delete" type="submit">Delete</button>
              <a class="btn btn-lg btn-primary btn-block text-uppercase" href="dashboard.php">Cancel</a>
              <!-- </div> -->
            </form>
